...
static constexpr uint8_t O_LIGHT_RELAY_ACTIVATE_PIN   = D8;
static constexpr uint8_t O_PLANT_VALVE_PINS[]         = {D6, D7};
...
static constexpr uint8_t ANALOG_PLANT_SENSOR_ADDR[]   = {1, 2};
static constexpr uint8_t UNUSED_ANALOG_SENSOR_ADDR    = 3;

static constexpr uint8_t MAX_PLANT_COUNT = sizeof(O_PLANT_VALVE_PINS)/sizeof(O_PLANT_VALVE_PINS[0]);
